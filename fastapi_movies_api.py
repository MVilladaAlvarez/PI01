...
# Load the cleaned datasets with specified dtypes to avoid DtypeWarning
movies_path = 'C:/Users/teo08/OneDrive/Documentos/PI/Transformation/movies_dataset_transformed.csv'
credits_path = 'C:/Users/teo08/OneDrive/Documentos/PI/Transformation/cleaned_credits.csv'

# Load the datasets specifying dtype to handle mixed types and avoid warnings
